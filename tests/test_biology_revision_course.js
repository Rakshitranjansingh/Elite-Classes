...
assert(revHubHtml.includes('3 Subjects Live'), 'Revision hub must show 3 Subjects Live');
console.log('✔ revision_course_hub.html verified with biology link and 3 Subjects Live counter.');
