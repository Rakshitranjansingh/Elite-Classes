# -*- coding: utf-8 -*-
"""
Assemble Chapter 11 Course Data
Combines Part 1 (m01-m10) and Part 2 (m11-m20)
Outputs to modules/course/data/class10/science/chapter11_course_data.js
"""
import json

with open('scratch/ch11_part1.json', 'r', encoding='utf-8') as f:
    part1 = json.load(f)

with open('scratch/ch11_part2.json', 'r', encoding='utf-8') as f:
    part2 = json.load(f)
...
const COURSE_CHAPTER_11_SCIENCE = {json.dumps(chapter11_data, indent=4, ensure_ascii=False)};
...
target_path = 'modules/course/data/class10/science/chapter11_course_data.js'
with open(target_path, 'w', encoding='utf-8') as f:
    f.write(output_content)

print(f"Successfully assembled Chapter 11 course data to {target_path}!")
