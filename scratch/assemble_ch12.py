...
part1 = json.load(open("scratch/ch12_part1.json", "r", encoding="utf-8"))
part2 = json.load(open("scratch/ch12_part2.json", "r", encoding="utf-8"))
...
const COURSE_CHAPTER_12_SCIENCE = {json.dumps(course_obj, indent=2, ensure_ascii=False)};

if (typeof window !== 'undefined') {{
    window.COURSE_CHAPTER_DATA = COURSE_CHAPTER_12_SCIENCE;
}}
if (typeof module !== 'undefined' && module.exports) {{
    module.exports = COURSE_CHAPTER_12_SCIENCE;
}}
"""

with open("modules/course/data/class10/science/chapter12_course_data.js", "w", encoding="utf-8") as f:
    f.write(js_content)

print("Saved modules/course/data/class10/science/chapter12_course_data.js")
